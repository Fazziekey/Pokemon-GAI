...
def battle(pokemon1: Pokemon = None, pokemon2: Pokemon = None):
    ...
    results.append(f"{pokemon1.name} ({pokemon1.element_type.name}) has {pokemon1.hp:.2f} hp and {pokemon1.attack:.2f} attack")
    results.append(f"{pokemon2.name} ({pokemon2.element_type.name}) has {pokemon2.hp:.2f} hp and {pokemon2.attack:.2f} attack")
    ...
    while pokemon1.hp > 0 and pokemon2.hp > 0:
        ...
        print(f"{pokemon1.name} ({pokemon1.element_type.name}) attacks {pokemon2.name} ({pokemon2.element_type.name}) and deals {damage:.2f} damage!, remaining hp: {pokemon2.hp:.2f}")
        results.append(f"{pokemon1.name} ({pokemon1.element_type.name}) attacks {pokemon2.name} ({pokemon2.element_type.name}) and deals {damage:.2f} damage!, remaining hp: {pokemon2.hp:.2f}")
        ...
        print(f"{pokemon2.name} ({pokemon2.element_type.name}) attacks {pokemon1.name} ({pokemon1.element_type.name}) and deals {damage:.2f} damage!, remaining hp: {pokemon1.hp:.2f}")
        results.append(f"{pokemon2.name} ({pokemon2.element_type.name}) attacks {pokemon1.name} ({pokemon1.element_type.name}) and deals {damage:.2f} damage!, remaining hp: {pokemon1.hp:.2f}")
